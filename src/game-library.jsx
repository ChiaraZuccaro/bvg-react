...
export const games = [
  ...
  // Rise tomb raider
  {
    ...
    description: `Rise of the Tomb Raider is a third-person action-adventure game in which players control Lara Croft, who is on a quest to discover the legendary city of Kitezh. /n 
      Combat is a major gameplay mechanic; Lara has a large variety of weapons at her disposal (including assault rifles, shotguns, and pistols), some of which have an alternate firing mode. /n
      Players may also utilize stealth to progress through portions of the game, using bows and arrows to take out enemies, creating distractions to draw enemy attention away from Lara, or hiding in bushes to evade enemies. /n
      Lara can use the environment to fight enemies, shooting explosive barrels, tearing down rope-wrapped structures with rope arrows, or ambushing enemies from high ground. She can also use her ice axe and combat knife to engage in melee combat with enemies. /n 
      Completing objectives and side content and eliminating enemies give players experience points (XP). When players collect sufficient XP they level up, receiving a skill point, which can be spent on the game's three skill trees: Brawler, Hunter and Survivor. /n 
      Brawler enhances Lara's efficiency with weapons, giving her abilities such as retrieving arrows from corpses and a steady aim, as well as boosting her resilience against attack and unlocks new combat skills, such as dodge kill. /n 
      Hunter gives her an advantage when dealing with the environments and animals. /n 
      Survivor covers a wide range of skills such as creating incendiary bombs and setting booby traps. /n 
      Lara learns new languages, enabling her to discover relics (such as coins) which can be traded for new equipment. /n 
      The game has semi-open hubs for players to explore. In the hubs are items for Lara to collect, including crafting materials and survival caches. These items and collectibles such as relics and documents can be revealed to players using Survival Instinct, a vision mode which highlights items of interest. By collecting the materials, players can craft items with the game's crafting menu; Lara can craft ammunition, poisoned arrows (using death-cap mushrooms), and Molotov cocktails and hand grenades from cans and bottles. /n 
      The open areas are filled with wildlife, which can be hunted to collect more resources. Players can discover and explore challenge tombs for new skills and outfits. Lara's outfit, which affects her combat performance, can be changed at base camps. /n 
      The camps allow Lara to change her weapon loadouts, and are fast travel points which allow players to explore a previously-searched area. /n 
      The game has side missions and challenges which may give players new equipment, and players navigate intricate environments to progress. Lara can use her ice axe to climb certain surfaces (such as cliffs and glaciers) and her rope arrows to create ziplines to access difficult-to-reach areas, and can climb trees and swim. /n 
      Players solve puzzles during the game, in its main campaign and optional content. The puzzles, based on in-game physics, often connect; players must solve connecting puzzles to solve a larger one.`,
  },
  // detroit become human
  {
    ...
    description: `Detroit: Become Human is an adventure game played from a third-person view, which is subject to a set and controllable perspective. /n
    There are multiple playable characters who can die as the story continues without them; as a result, there is no "game over" message following a character's death. The right analogue stick on the DualShock controller is used to interact with objects and observe one's surroundings, the left is for movement, and R2 scans an environment for possible actions; the motion controls and touchpad are also employed. /n
    Via quick time events and dialogue decisions, the story will branch out depending on which choices are made. These can be viewed in a flowchart during and immediately after a given chapter; the player can rewind to certain points in the story to reshape decisions in the event of regret. Certain scenes feature countdowns, which force quick action. Levels abound with magazines for players to read. The playable characters are: /n

    - Connor, a police investigator android tasked with hunting down androids that have deviated from their programmed behaviours. /n
    - Kara, a housekeeper android who develops artificial consciousness and becomes responsible for a young girl's safety. /n
    - Markus, a caretaker android who, after gaining consciousness, takes it upon himself to free others like him from bondage. /n
  ...
  // dmc
  {
    ...
    description: `DmC: Devil May Cry is an action-adventure hack and slash video game. Players take on the role of Dante as he uses his powers and weaponry to fight against enemies and navigate the treacherous Limbo. /n
    Like previous games in the series, Dante can perform combos by attacking with his sword, Rebellion, and shooting with his twin pistols, Ebony and Ivory. /n
    New to the series are modifiers to Dante's moveset, known as Angel Mode and Devil Mode, activated by holding down one of the trigger buttons. When in Angel mode, Dante's sword attacks change to the Osiris, a speedy scythe type weapon, whilst Devil mode uses the slower but more powerful axe, Arbiter. /n
    These modes also alter Dante's mobility. Using Angel mode allows Dante to pull himself towards enemies and various points in each level, whilst Devil mode lets Dante pull enemies and objects towards him. Dante is also able to dash across large gaps in Angel mode. /n
    All of these moves can be used in conjunction with each other to perform massive combos, which are ranked based on the damage the player makes. When enough power has been gathered, Dante can activate Devil Trigger mode, which slows down time around him and levitates enemies into the air, allowing him to perform much stronger attacks. /n
    Like previous games, Dante can collect various types of souls which can be used to recover health, purchase items and upgrade Dante's moveset.`,
  },
  // Assassin odyssey
  {
    ...
    description: `Assassin's Creed Odyssey is an action role-playing video game played from a third-person perspective. /n
    At the beginning of the game, the player can select to play as either Alexios or Kassandra, Greek mercenaries and descendants of the Spartan king Leonidas I. /n
    In addition to completing the story campaign, players can freely explore a large open world set in Greece on foot or on horseback. As the player explores the world, they will encounter various non-playable characters (NPCs) who give players side missions to complete. /n
    They also discover locations of interests, clear out fortresses and camps, explore tombs and shipwrecks, and collect hidden treasures. Synchronization points in various landmarks in Greece, which serve as fast travel points, can also be unlocked. /n
    Players can also collect various crafting resources, such as iron ore, wood, leather, metal, and precious gems, through exploration and hunting wildlife. Other side activities players can undertake include competing in a gladiatorial arena and completing time-limited bounties and contracts. /n
    Unlike the previous games in the series, Odyssey offers two modes of gameplay: Guided mode shows the player the locations of their objects immediately using waypoints, while Exploration mode tasks players to find out the locations themselves after being given brief clues from other NPCs. /n
    While the main campaign missions follow the mercenary as they reunite their family and stop the Cult of Kosmos, additional questlines task the players to defeat mystical creatures from Atlantis and take down cultists. /n
    As the game is set during the Peloponnesian War, Athens and Sparta control various parts of Greece. An area can be weakened if the player assassinates the nation leader, defeats members of their army, burns down war supplies, or pillages their nation chests. /n
    When a region is weakened, players can join a conquest battle to aid either the attacking or the defending side. Winning a battle will earn the player valuable loots and gears. Joining the attacking team is a more challenging experience but it will offer more gameplay benefits. /n
    A bounty is placed on the player character if they commit a crime such as stealing or hurting an innocent bystander in public. NPCs called Mercenaries will then arrive to hunt the player character, who can either kill the mercenary, pay the bounty, or assassinate the character who place the bounty on them. /n
    Each area has a recommended level. The player may be easily overpowered if they venture into an area too early. /n
    However, the game's difficulty is scaled in accordance to the player's level. When interacting with other NPCs, players can select various dialogue options, including the option to develop a romantic relationship with some of them. /n
    At key moments of the game's campaign, players make crucial decisions which can affect the course of the story and lead to several different endings`,
  },
];

...
function App() {
  ...
  return (
    <Router>
        ...
        <Routes>
          <Route path="/gallery/detroit-become-human" element={<SingleGame renderGame="detroit become human"/>} />

          <Route path="/gallery/days-gone" element={<SingleGame renderGame="days gone"/>} />

          <Route path="/gallery/rise-of-tomb-raider" element={<SingleGame renderGame="rise of tomb raider"/>} />
